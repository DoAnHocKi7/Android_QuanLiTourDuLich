...
public class TourLogicPresenter implements TourImplementPresenter {
    private RequestQueue requestQueue;
    final private Context context;
    ArrayList<TourModel> tourModels;

    public TourLogicPresenter(Context context) {
        this.context = context;
        this.requestQueue = Volley.newRequestQueue( this.context );
        this.tourModels = new ArrayList<>();
    }

    public void getTourDulich(final VolleyCallback callback) {
